...
public class HeldItemChangePacketAdapter extends PacketAdapter {
	...
	public void onPacketReceiving(PacketEvent event) {
		...
		ChipUtil.fix(player.getInventory().getItemInMainHand(), Optional.of(player.getName()), Optional.of(ChipUtil.getLocationString(player.getLocation())), Optional.of(player.getInventory()));
	}
